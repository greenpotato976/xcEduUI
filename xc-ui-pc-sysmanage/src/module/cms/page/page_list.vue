<template>
  ...
  <div>
    ...
    <el-form :model="params">
      ...
      <el-button type="primary" size="small">新增页面</el-button> </router-link>
    </el-form>
    ...
    <el-table-column prop="pageType" label="页面类型" width="90"> </el-table-column>
    <el-table-column prop="pageWebPath" label="访问路径" width="270"> </el-table-column>
    <el-table-column prop="pagePhysicalPath" label="物理路径" width="330"> </el-table-column>
    <el-table-column prop="pageCreateTime" label="创建时间" width="250" > </el-table-column>
  ...
  export default {
    ...
    methods:{
      ...
      preview:function(pageId){
        window.open("http://www.xuecheng.com/cms/config/preview/"+pageId)
      },
